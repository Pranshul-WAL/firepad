...
firepad.Firepad = (function (global) {
  ...
  Firepad.prototype.exportAsPdf = function () {
    var source = window.document.getElementsByClassName('CodeMirror cm-s-default CodeMirror-wrap')[0] ;
  ...
  //  source.style.height="auto";
    ...
    // html2canvas(source, {
    //   scale: 0.7, // Adjusts your resolution
    // }).then(canvas => 
    //     {
    ...
    console.log('totalPages:', totalPDFPages)

    html2canvas(source, { allowTaint: true }).then(function (canvas) {
    ...
    // html2canvas(source).then(canvas => {    
      ...
      // console.log('first hleft:', heightLeft)
      // const contentDataURL = canvas.toDataURL('image/png')    
      // let pdf = new jsPDF('p', 'mm', 'a4'); // A4 size page of PDF    
      // var position = 0;    
      // pdf.addImage(contentDataURL, 'PNG', 0, position, imgWidth, imgHeight)    
      // heightLeft -= pageHeight; 
      // console.log('second hleft:', heightLeft)
      // while (heightLeft >= 0) {  
  ...
  Firepad.prototype.makeDialog_ = function (id, placeholder) {
    ...
    var cb = function () {
      ...
      if (src !== null)
       self.insertEntity(id, { 'src': imgSrc, 'width': 400, 'height': 400 });
      self.firepadWrapper_.removeChild(dialog);
    };

    var input = utils.elt('input', null, { 'class': 'firepad-dialog-input', 'id': id, 'type': 'file', 'placeholder': placeholder, 'autofocus': 'autofocus' });
  ...
  Firepad.prototype.addToolbar_ = function () {
    ...
    this.toolbar.on('export-image', this.exportAsPdf, this);
