...
firepad.Firepad = (function (global) {
  ...
  Firepad.prototype.makeImageDialog_ = function () {
    ...
    utils.elt('input', null, { 'class': 'firepad-dialog-input', 'id': id, 'type': 'file', 'accept': '.png, .jpg, .jpeg', 'onchange': loadFile(event), 'placeholder': placeholder, 'autofocus': 'autofocus' });
